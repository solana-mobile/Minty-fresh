...
import com.solanamobile.mintyfresh.mintycore.metaplex.jen.U128
...
@Serializable
data class storageAccountV2(
    val immutable: Boolean,
    val toBeDeleted: Boolean,
    val deleteRequestEpoch: UInt,
    val storage: ULong,
    @Serializable(with=PublicKeyAs32ByteSerializer::class) val owner1: PublicKey,
    val accountCounterSeed: UInt,
    val creationTime: UInt,
    val creationEpoch: UInt,
    val lastFeeEpoch: UInt,
